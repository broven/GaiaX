...
public class Blurry {
    ...
    public static class Composer {
        ...
        public void onto(final ViewGroup target) {
            ...
            if (factor.width == 0 && factor.height == 0) {
                factor.width = target.getLayoutParams().width;
                factor.height = target.getLayoutParams().height;
            }
    ...
    public static class ImageComposer {
        ...
        public void into(final ImageView target) {
            ...
            if (factor.width == 0 && factor.height == 0) {
                factor.width = capture.getLayoutParams().width;
                factor.height = capture.getLayoutParams().height;
            }
            if (async) {
